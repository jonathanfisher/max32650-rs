#[doc = "Reader of register LPWKEN3"]
pub type R = crate::R<u32, super::LPWKEN3>;
#[doc = "Writer for register LPWKEN3"]
pub type W = crate::W<u32, super::LPWKEN3>;
#[doc = "Register LPWKEN3 `reset()`'s with value 0"]
impl crate::ResetValue for super::LPWKEN3 {
    type Type = u32;
    #[inline(always)]
