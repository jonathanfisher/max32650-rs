#[doc = "Reader of register LPWKEN0"]
pub type R = crate::R<u32, super::LPWKEN0>;
#[doc = "Writer for register LPWKEN0"]
pub type W = crate::W<u32, super::LPWKEN0>;
#[doc = "Register LPWKEN0 `reset()`'s with value 0"]
impl crate::ResetValue for super::LPWKEN0 {
    type Type = u32;
    #[inline(always)]
