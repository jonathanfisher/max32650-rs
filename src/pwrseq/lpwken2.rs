#[doc = "Reader of register LPWKEN2"]
pub type R = crate::R<u32, super::LPWKEN2>;
#[doc = "Writer for register LPWKEN2"]
pub type W = crate::W<u32, super::LPWKEN2>;
#[doc = "Register LPWKEN2 `reset()`'s with value 0"]
impl crate::ResetValue for super::LPWKEN2 {
    type Type = u32;
    #[inline(always)]
