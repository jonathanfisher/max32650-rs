#[doc = "Reader of register ER_INT_EN"]
pub type R = crate::R<u16, super::ER_INT_EN>;
#[doc = "Writer for register ER_INT_EN"]
pub type W = crate::W<u16, super::ER_INT_EN>;
#[doc = "Register ER_INT_EN `reset()`'s with value 0"]
impl crate::ResetValue for super::ER_INT_EN {
    type Type = u16;
    #[inline(always)]
...
#[doc = "Reader of field `VENDOR`"]
pub type VENDOR_R = crate::R<bool, bool>;
...
impl R {
    ...
    pub fn vendor(&self) -> VENDOR_R {
        VENDOR_R::new(((self.bits >> 12) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Command Timeout Error Status Enable."]
