#[doc = "Reader of register INT_SIGNAL"]
pub type R = crate::R<u16, super::INT_SIGNAL>;
#[doc = "Writer for register INT_SIGNAL"]
pub type W = crate::W<u16, super::INT_SIGNAL>;
#[doc = "Register INT_SIGNAL `reset()`'s with value 0"]
impl crate::ResetValue for super::INT_SIGNAL {
    type Type = u16;
    #[inline(always)]
