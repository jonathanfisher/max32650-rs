#[doc = "Reader of register MXM_INT_EN"]
pub type R = crate::R<u32, super::MXM_INT_EN>;
#[doc = "Writer for register MXM_INT_EN"]
pub type W = crate::W<u32, super::MXM_INT_EN>;
#[doc = "Register MXM_INT_EN `reset()`'s with value 0"]
impl crate::ResetValue for super::MXM_INT_EN {
    type Type = u32;
    #[inline(always)]
