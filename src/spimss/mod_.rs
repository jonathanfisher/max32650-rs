...
#[doc = "Reader of field `SSV`"]
pub type SSV_R = crate::R<bool, SSV_A>;
impl SSV_R {
...
#[doc = "Reader of field `TX_LJ`"]
pub type TX_LJ_R = crate::R<bool, TX_LJ_A>;
impl TX_LJ_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TX_LJ`"]
...
#[doc = "Reader of field `SSL1`"]
pub type SSL1_R = crate::R<bool, SSL1_A>;
impl SSL1_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `SSL1`"]
pub struct SSL1_W<'a> {
    w: &'a mut W,
}
impl<'a> SSL1_W<'a> {
...
#[doc = "Reader of field `SSL2`"]
pub type SSL2_R = crate::R<bool, SSL2_A>;
impl SSL2_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `SSL2`"]
pub struct SSL2_W<'a> {
    w: &'a mut W,
}
impl<'a> SSL2_W<'a> {
...
#[doc = "Reader of field `SSL3`"]
pub type SSL3_R = crate::R<bool, SSL3_A>;
impl SSL3_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `SSL3`"]
pub struct SSL3_W<'a> {
    w: &'a mut W,
}
impl<'a> SSL3_W<'a> {
