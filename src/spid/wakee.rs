#[doc = "Reader of register WAKEE"]
pub type R = crate::R<u32, super::WAKEE>;
#[doc = "Writer for register WAKEE"]
pub type W = crate::W<u32, super::WAKEE>;
#[doc = "Register WAKEE `reset()`'s with value 0"]
impl crate::ResetValue for super::WAKEE {
    type Type = u32;
    #[inline(always)]
