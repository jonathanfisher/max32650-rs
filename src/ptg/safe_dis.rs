#[doc = "Writer for register SAFE_DIS"]
pub type W = crate::W<u32, super::SAFE_DIS>;
#[doc = "Register SAFE_DIS `reset()`'s with value 0"]
impl crate::ResetValue for super::SAFE_DIS {
    type Type = u32;
    #[inline(always)]
